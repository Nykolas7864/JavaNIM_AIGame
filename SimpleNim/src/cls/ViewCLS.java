...
public class ViewCLS extends JFrame
...
{  
    ...
    protected JCheckBox  LearningCheck = new JCheckBox("Prescription File",true);
	...
	public void updateState(int padsleft, String playername) {
		...
		if (padsleft <= 0) {
			...
			win(playername);
			System.out.println("Game Ended, now we learn!");
			stop = true;
		}
		else {
